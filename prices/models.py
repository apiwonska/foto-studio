...
class PriceList(models.Model):
    ...
    title_price_list = models.CharField(
        max_length=100, verbose_name='nazwa cennika')
    order = models.PositiveSmallIntegerField(
        verbose_name='kolejność tabel')
...
class Price(models.Model):
    ...
    price_list = models.ForeignKey(
        PriceList, on_delete=models.CASCADE, verbose_name='cennik')
    service = models.CharField(max_length=200, verbose_name='usługa')
    service_details = models.CharField(
        null=True, blank=True, max_length=200, verbose_name='szczegóły')
    price = models.CharField(max_length=20, verbose_name='cena')
    order = models.PositiveSmallIntegerField(
        verbose_name='kolejność ceny w tabeli')
